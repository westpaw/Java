...
/* Conor Gaffney
 * This program generates magic squares of a size specified by the user.  The dimentions must be between 3 and 19, and must be odd.
 * A magic square is comprised of numbers in such a way that every row, column, and diagonal's numers sum to the same total.
 */
public class MagicSquares 
{
	...
	public int askDimention() throws IOException
	{
		InputStreamReader reader = new InputStreamReader(System.in);
		BufferedReader input = new BufferedReader(reader);
		
		System.out.println("Enter an odd number to be the dimention of a magic square");
		int d = Integer.parseInt(input.readLine());
		while(d < 3 || d % 2 == 0 || 20 < d)
		{
			System.out.println("Invalid dimention value, please enter an odd number between 3 and 19");
	...
	public void makeSquare(int n) //forms and prints magic square
	{
		System.out.println();
		square = new int[n][n];
		int r = 0;
	...
	{
		MagicSquares magicSquare = new MagicSquares();
		magicSquare.makeSquare(magicSquare.askDimention());
	}
	/*
	 * Enter an odd number to be the dimention of a magic square
5
